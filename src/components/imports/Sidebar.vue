...
<template>
  <div class="flex">
    ...
    <div
      ...
      class="fixed inset-0 z-20 transition-opacity bg-slate-50 opacity-50 lg:hidden"
      @click="isOpen = false"
    />
    <!-- End Backdrop -->
    ...
    <div
      ...
      class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform  bg-slate-50 lg:translate-x-0 lg:static lg:inset-0"
    >
      <div class="flex items-center justify-center">
        <div class="flex items-center p-6">
          <img src="../../assets/logo/ite_logo.svg" alt="" class=" bg-white w-20">
